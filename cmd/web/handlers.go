...
func (app *application) home(w http.ResponseWriter, r *http.Request) {
	...
	// // Initialize a slice containg the paths to the two files. Note that the
	...
	// Use the template.ParseFiles() function to read the template file into the
	// template set. If there's an error, we log the detailed error message
	// to the custom serverError method.
